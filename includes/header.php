    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasSearch" aria-labelledby="Search">
      ...
      <div class="offcanvas-body">
        <div class="order-md-last">
          ...
          <form role="search" action="/FoodMartLab/index.php" method="get" class="d-flex mt-3 gap-0">
      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-4 col-lg-3 text-center text-sm-start">
            <div class="main-logo">
              <a href="/FoodMartLab/">
                <img src="/FoodMartLab/assets/images/logo.png" alt="logo" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
            <div class="search-bar row bg-light p-2 my-2 rounded-4">
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="/FoodMartLab/index.php" method="post">
