...
<head>
  ...
  <style>
    /* --- FIX Tailwind overlay bị đè bởi theme CSS --- */
...
<body>
  ...
  <!-- ================= HEADER ================= -->
  <header class="border-bottom py-3 bg-white shadow-sm relative z-[1000]">
            ...
            <?php if (isset($_SESSION['user'])): ?>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2" aria-labelledby="userDropdown">
                  ...
                  <li><a class="dropdown-item" href="<?= BASE_URL ?>account/orders"><i class="bi bi-receipt me-2"></i> Đơn hàng của tôi</a></li>
                  <li>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart" aria-labelledby="MyCartLabel">
    <div class="offcanvas-header justify-content-between">
      <h5 class="offcanvas-title text-primary" id="MyCartLabel">
        <svg width="22" height="22" style="display: inline" ;>
