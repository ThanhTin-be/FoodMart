    ...
    <section class="py-5">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-6">
            <figure>
              <img src="<?= asset('assets/images/post-thumb-1.jpg') ?>" alt="Sample Image" class="img-fluid">
              <figcaption>Sample Caption</figcaption>
            </figure>
          </div>
          <div class="col-md-6">
            <figure>
              <a href="images/product-large-3.jpg" title="Calm Before The Storm (One Shoe Photography Ltd.)" class="image-link"><img src="<?= asset('assets/images/product-large-3.jpg') ?>" alt="Sample Image" class="img-fluid"></a>
