  ...
  <div class="max-w-4xl px-8 mx-auto sm:px-6 lg:px-8">
    ...
    <div class="max-w-4xl px-4 py-6 mx-auto sm:px-6 lg:px-8">
      ...
      <div class="flex flex-col justify-center gap-4 mt-12 sm:flex-row">
        ...
        <a href="<?= BASE_URL ?>account/orders" class="inline-flex items-center justify-center px-8 py-3 text-base font-medium text-white transition-all duration-200 rounded-full shadow-sm bg-emerald-600 hover:bg-emerald-700">
          <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
