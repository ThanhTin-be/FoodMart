                ...
                <table class="w-full table table-striped">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">PayMent_Status</th>
                        ...
                        <?php else: ?>
                            ...
                            <?php foreach ($orders as $order): ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4"><?php echo htmlspecialchars($order['payment_status'] ?? 'pending'); ?></td>
