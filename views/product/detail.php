            ...
            <div class="row flex-column-reverse flex-lg-row">
                ...
                <div class="swiper product-thumbnail-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="/FoodMartLab/assets/images/product-thumbnail-1.jpg" alt="" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="/FoodMartLab/assets/images/product-thumbnail-2.jpg" alt="" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="/FoodMartLab/assets/images/product-thumbnail-3.jpg" alt="" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="/FoodMartLab/assets/images/product-thumbnail-4.jpg" alt="" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="/FoodMartLab/assets/images/product-thumbnail-5.jpg" alt="" class="thumb-image img-fluid">
                    </div>
                  </div>
                </div>
                <!-- / product-thumbnail-slider -->
              ...
              <div class="col-md-12 col-lg-10">
                ...
                <div class="swiper product-large-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="/FoodMartLab/assets/images/product-large-1.jpg"><img
                          src="/FoodMartLab/assets/images/product-large-1.jpg" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="/FoodMartLab/assets/images/product-large-2.jpg"><img
                          src="/FoodMartLab/assets/images/product-large-2.jpg" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="/FoodMartLab/assets/images/product-large-3.jpg"><img
                          src="/FoodMartLab/assets/images/product-large-3.jpg" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="/FoodMartLab/assets/images/product-large-4.jpg"><img
                          src="/FoodMartLab/assets/images/product-large-4.jpg" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="/FoodMartLab/assets/images/product-large-5.jpg"><img
                          src="/FoodMartLab/assets/images/product-large-5.jpg" alt="product-large" class="img-fluid"></div>
                    </div>
                  </div>
              ...
              <div class="tab-pane fade" id="v-pills-reviews" role="tabpanel" aria-labelledby="v-pills-reviews-tab" tabindex="0">
                <div class="review-box d-flex flex-wrap">
                  <div class="col-lg-6 d-flex flex-wrap gap-3">
                    <div class="col-md-2">
                      <div class="image-holder">
                        <img src="/FoodMartLab/assets/images/reviewer-1.jpg" alt="review" class="img-fluid rounded-circle">
                      </div>
                    </div>
                    <div class="col-md-8">
                  ...
                  <div class="col-lg-6 d-flex flex-wrap gap-3">
                    <div class="col-md-2">
                      <div class="image-holder">
                        <img src="/FoodMartLab/assets/images/reviewer-2.jpg" alt="review" class="img-fluid rounded-circle">
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div class="review-content">
            ...
            <div class="products-carousel swiper">
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="product-single.html" title="Product Title">
                      <img src="/FoodMartLab/assets/images/thumb-tomatoes.png"  class="tab-image">
                    </a>
                  </figure>
                ...
                <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="product-single.html" title="Product Title">
                      <img src="/FoodMartLab/assets/images/thumb-tomatoketchup.png"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                ...
                <div class="product-item swiper-slide">
                  ...
                  <figure>
                    <a href="product-single.html" title="Product Title">
                      <img src="/FoodMartLab/assets/images/thumb-bananas.png"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
