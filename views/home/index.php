        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="/FoodMartLab/index.php" class="nav-link category-item swiper-slide">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="product-item swiper-slide">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="single-product.php" class="nav-link">Add to Cart <iconify-icon icon="uil:shopping-cart"></a>
                  </div>
                </div>
