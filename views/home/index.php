            ...
            <?php foreach ($products as $p): ?>
              <div class="col">
                <div class="product-item">
                  <!-- badge giảm giá (demo cứng, sau này thêm cột discount) -->
                  <span class="badge bg-success position-absolute m-3">-10%</span>
                  ...
                  <!-- hình ảnh -->
                  <figure>
                    <a href="<?= BASE_URL ?>product/detail/<?= $p['id'] ?>" title="<?= htmlspecialchars($p['name']) ?>">
                      <img src="<?= asset('assets/images/' . $p['image']) ?>" class="tab-image">
                    </a>
                  </figure>

                  <!-- tên + mô tả ngắn -->
                  <h3><?= htmlspecialchars($p['name']) ?></h3>
                  <span class="qty"><?= $p['short_desc'] ?? '1 Unit' ?></span>

                  <!-- rating: demo cứng 4.5 -->
                  <span class="rating">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?= BASE_URL ?>cart/add/<?= $p['id'] ?>" class="nav-link">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-header d-flex flex-wrap justify-content-between my-5">
          ...
          <div class="d-flex align-items-center">
            <a href="<?= BASE_URL ?>product" class="btn-link text-decoration-none">View All Products →</a>
            <div class="swiper-buttons">
            ...
            <?php if (!empty($bestSellers)): ?>
              <?php foreach ($bestSellers as $p): ?>
                <div class="product-item swiper-slide">
                  <!-- badge giảm giá (demo cứng - TODO: thêm discount column sau) -->
        ...
        <div class="products-carousel swiper">
          <div class="swiper-wrapper">
            ...
            <?php if (!empty($mostPopular)): ?>
              ...
              <?php endforeach; ?>
            <?php else: ?>
              <p class="text-muted">Chưa có sản phẩm phổ biến.</p>
            <?php endif; ?>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="products-carousel swiper">
          <div class="swiper-wrapper">
            <?php if (!empty($justArrived)): ?>
              <?php foreach ($justArrived as $item): ?>
                <div class="product-item swiper-slide">
                  <a href="#" class="btn-wishlist">
                    <svg width="24" height="24"><use xlink:href="#heart"></use></svg>
                  </a>
                  <figure>
                    <a href="<?= BASE_URL ?>product/detail/<?= $item['id'] ?>" title="<?= $item['name'] ?>">
                      <img src="<?= asset('assets/images/' . $item['image']) ?>" class="tab-image">
                    </a>
                  </figure>
                  <h3><?= htmlspecialchars($item['name']) ?></h3>
                  <span class="qty"><?= $item['short_desc'] ?? '1 Unit' ?></span>
                  <span class="rating">
                    <svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5
                  </span>
            ...
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="<?= BASE_URL ?>blog/detail/<?= $post['id'] ?>">
                  <img src="<?= asset('assets/images/' . $post['thumbnail']) ?>" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
