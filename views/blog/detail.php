              ...
              <article class="post-item">
                <div class="post-content">
                  <div class="post-thumbnail mb-5">
                    <img src="<?= asset('banner-image-1.jpg') ?>" alt="single-post" class="img-fluid">
                  </div>
                  <div class="post-description py-4">
                    ...
                    <img src="<?= asset('banner-image-2.jpg') ?>" alt="post-image" class="img-fluid">
                    <p>
                        ...
                        <div class="comment-list padding-small">
                          <article class="comment-item d-flex flex-wrap mb-3">
                            <div class="col-lg-1 col-sm-3 me-4 mb-3">
                              <img src="<?= asset('reviewer-1.jpg') ?>" alt="default" class="img-fluid rounded-circle">
                            </div>
                          ...
                          <article class="comment-item d-flex child-comments flex-wrap ps-5 mb-3">
                            <div class="col-lg-1 col-sm-3 me-4 mb-3">
                              <img src="<?= asset('reviewer-2.jpg') ?>" alt="default" class="img-fluid rounded-circle">
                            </div>
                            <div class="col-lg-10 col-sm-9 author-wrap">
                              <div class="author-post">
                                <div class="comment-meta d-flex">
                          ...
                          <article class="comment-item d-flex flex-wrap">
                            <div class="col-lg-1 col-sm-3 me-4 mb-3">
                              <img src="<?= asset('reviewer-3.jpg') ?>" alt="default" class="img-fluid rounded-circle">
                            </div>
                            <div class="col-lg-10 col-sm-9 author-wrap">
                              <div class="author-post">
                                <div class="comment-meta d-flex">
