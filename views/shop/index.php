            ...
            <div class="product-grid row row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
                ...
                <div class="product-item">
                  ...
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="<?= asset('thumb-orange-juice.png') ?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
              ...
              <div class="col">
                <div class="product-item">
                  ...
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="<?= asset('thumb-raspberries.png') ?>" alt="Product Thumbnail" class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
              ...
              <div class="col">
                <div class="product-item">
                  ...
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="<?= asset('thumb-bananas.png') ?>"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
              ...
              <div class="col">
                <div class="product-item">
                  ...
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="<?= asset('thumb-biscuits.png') ?>"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
              ...
              <div class="col">
                <div class="product-item">
                  ...
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="<?= asset('thumb-cucumber.png') ?>"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
              ...
              <div class="col">
                <div class="product-item">
                  ...
                  <figure>
                    <a href="single-product.html" title="Product Title">
                      <img src="<?= asset('thumb-milk.png') ?>"  class="tab-image">
                    </a>
                  </figure>
                  <h3>Sunstar Fresh Melon Juice</h3>
                  <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
